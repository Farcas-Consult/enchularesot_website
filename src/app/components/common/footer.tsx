        ...
        <div className="border-t border-white/40 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-white">
            ...
            <div className="flex gap-6 mt-4 md:mt-0">
              <Link href="/privacy-policy" className="hover:text-[#D7BFA8] transition-colors">Privacy Policy</Link>
              <Link href="/terms" className="hover:text-[#D7BFA8] transition-colors">Terms & Conditions</Link>
              <Link href="/cookies" className="hover:text-[#D7BFA8] transition-colors">Cookies</Link>
            </div>
          </div>
        </div>
      </div>
